...
class GuiWindow(wx.Frame):
    ...
    def speaker_idle_stage(self,coords):
        ...
        if Glbl.show_feedback_grid == True:
...
class WelcomePage(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        wx.Panel.__init__(self, parent)
        # Glbl.grid_sizer = wx.GridBagSizer()
        self.box_sizer = wx.BoxSizer(wx.VERTICAL)
...
class ListenerButtonsPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.box_sizer = wx.BoxSizer(wx.VERTICAL)
        # Issue here
        Glbl.grid_sizer = wx.FlexGridSizer(6,2,5,5)
        ...
        self.add_radio_box()
        self.box_sizer.Add(Glbl.grid_sizer, 0)
    ...
    def add_grid(self):
        ...
        for i, value in enumerate(self.speaker_coords):
            if value == 1:
                grid_coords.append([int(i/Glbl.grid_size), i%Glbl.grid_size])
...
class SpeakerButtonsPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.box_sizer = wx.BoxSizer(wx.VERTICAL)
        Glbl.grid_sizer = wx.FlexGridSizer(2,2)
...
class FeedbackPage(wx.Panel):
    ...
    def CreateFeedbackGrid(self,sent_coords):
        ...
        for i, value in enumerate(self.sent_coords):
            if value == 1:
                self.grid_coords.append([int(i/Glbl.grid_size), i%Glbl.grid_size])
        ...
        self.grid.CreateGrid(self.gui.GridWidth, self.gui.GridHeight)
        self.grid.SetDefaultColSize(int(Glbl.GridColSize / 1.5))
        self.grid.SetDefaultRowSize(int(Glbl.GridRowSize / 1.5))
        self.grid.SetRowLabelSize(0)
        self.grid.SetColLabelSize(0)
        self.grid.SetCellHighlightROPenWidth(0)
        self.grid.ShowScrollbars(wx.SHOW_SB_NEVER, wx.SHOW_SB_NEVER)
...
class DrawingPage(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.ref_list_text.SetFont(wx.Font(16.0, wx.DEFAULT, wx.NORMAL,wx.NORMAL))
        ...
        self.grid.CreateGrid(self.gui.GridWidth, self.gui.GridHeight)
        self.grid.SetDefaultColSize(Glbl.GridRowSize)
        self.grid.SetDefaultRowSize(Glbl.GridColSize)
        self.grid.SetRowLabelSize(0)
        self.grid.SetColLabelSize(0)
        self.grid.SetCellHighlightROPenWidth(0)
        self.grid.ShowScrollbars(wx.SHOW_SB_NEVER, wx.SHOW_SB_NEVER)
